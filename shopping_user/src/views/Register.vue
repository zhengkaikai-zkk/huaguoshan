<template>
    <div id="register" :style="{backgroundImage:('url('+bg+')')}">
        <div class="d_logo">
            <span></span>
            <a>LOGO</a>
        </div>
        <div class="d_login">
            ...
            <div class="d_input">
                <i class="iconfont">&#xe614;</i>
                <div><input placeholder="请输入邀请码  (选填)" v-model="formData.inviteCode" :readonly="readonly"></div>
            </div>
            <div class="btn">
