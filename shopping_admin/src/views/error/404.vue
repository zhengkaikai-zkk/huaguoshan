<template>
	<div id="err_404">
		...
		<div class="wrapper">
		    <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
		        <title>404</title>
    ...
    <div class="err_text">查找的页面不存在, 或许你没有权限进入！</div>
    <div class="err_btn">
      <button @click="$router.replace('/manage/welcome')">返回首页</button>
    </div>
	</div>
</template>
