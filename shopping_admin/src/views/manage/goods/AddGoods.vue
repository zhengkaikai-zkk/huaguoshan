            ...
            <el-form :model="formData" :rules="rules" ref="formData" label-position="right" label-width="100px">
                ...
                <div class="d_list">
                    ...
                    <el-form-item label="总库存">
                        <el-input value="0" class="formDataClass" disabled>
                ...
                <el-form-item label="" >
                    ...
                    <el-button @click="addProduct()" type="primary">下一步</el-button>
                </el-form-item>
            </el-form>
        </div>
        ...
        <el-dialog
            ...
            <el-form :model="couponFormData" :rules="couponRules" ref="couponFormData" label-width="94px">
                ...
                <el-form-item label="使用条件" prop="couponConditionValue">
                    <el-input placeholder="例如：输入400，即表示大于400可用" v-model="couponFormData.couponConditionValue"></el-input>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 提交规格组
            addGroup(){
                console.log("商品ID为："+this.formData.id);
                if(!this.groupName){
            ...
            addCoupon(){
                 this.$refs['couponFormData'].validate((valid) => {
                    ...
                    if (valid) {
                        ...
                        console.log("this.couponFormData: "+JSON.stringify(this.couponFormData));
                        this.$request.post({
                            ...
                            success: res =>{
                                ...
                                this.couponFormData.couponName = '';
                                this.couponFormData.couponMoney = '';
                                this.couponFormData.couponMoney = '';
                                this.couponFormData.couponConditionValue = '';
                                this.getCoupon();
                            },
                            finally: ()=>{
                                this.loading = false
        ...
        mounted(){
            ...
            this.active = this.formData.id ? 1: 0;
